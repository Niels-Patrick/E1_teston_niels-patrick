"""
Static configuration module of the backend Foxchess Flask API
...
class LoggerConfig:
    ...
    log_level: str = "INFO"
    log_file_name: str = "foxchess_flask_api.log"
...
@dataclass
class AppConfig:
    """General configuration for the Foxchess API"""
    title: str = "Foxchess API"
